package com.example.vivobook.shoppingapp;
...
//        ButterKnife.bind(this);
    ...
    public void sendItem(String itemText){
        //bikin intent baru(kosong)
        Intent itemIntent = new Intent();
        //menambahkan extra message nama itemtextnya
        itemIntent.putExtra(EXTRA_ITEM, itemText);
        //setresult bahwa data yang dikirim itu berkode"OK"
        setResult(RESULT_OK, itemIntent);
        //FINISH,kembalikan intent ke activity main
        finish();
    }
